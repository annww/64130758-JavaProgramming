...
public class FlashQuizGUI {
  ...
  void handelBtnA(ActionEvent event) {
    if (isOriginalColor) {
      btnA1.setStyle("-fx-background-color: #88C0E8; -fx-text-fill: white;" +
          "-fx-background-radius:  50;");
      btnA.setStyle("-fx-background-color: #88C0E8; -fx-text-fill: white;");
      btnB1.setStyle(
          "-fx-background-radius:  50;");
      btnB.setStyle("");
      btnC.setStyle("");
  ...
  void handelBtnB(ActionEvent event) {
    if (isOriginalColor1) {
      btnB1.setStyle("-fx-background-color: #88C0E8; -fx-text-fill: white;" +
          "-fx-background-radius:  50;");
      btnB.setStyle("-fx-background-color: #88C0E8; -fx-text-fill: white;");
      btnA1.setStyle(
          "-fx-background-radius:  50;");
      btnA.setStyle("");
      btnC.setStyle("");
  ...
  void handelBtnC(ActionEvent event) {
    if (isOriginalColor2) {
      btnC1.setStyle("-fx-background-color: #88C0E8; -fx-text-fill: white;" +
          "-fx-background-radius:  50;");
      btnC.setStyle("-fx-background-color: #88C0E8; -fx-text-fill: white;");
      btnB1.setStyle(
          "-fx-background-radius:  50;");
      btnB.setStyle("");
      btnA.setStyle("");
  ...
  void handelBtnD(ActionEvent event) {
    if (isOriginalColor3) {
      btnD1.setStyle("-fx-background-color: #88C0E8; -fx-text-fill: white;" +
          "-fx-background-radius:  50;");
      btnD.setStyle("-fx-background-color: #88C0E8; -fx-text-fill: white;");
      btnB1.setStyle(
          "-fx-background-radius:  50;");
      btnB.setStyle("");
      btnC.setStyle("");
